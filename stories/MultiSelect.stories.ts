...
function createMultiSelect(
  ...
  wrapper.id = id;
  wrapper.className = `aural-multi-select${config.size ? ` aural-multi-select--${config.size}` : ''}`;
...
export const Small: Story = {
  render: () => {
    ...
    return createMultiSelect('multi-select-small', options, {
...
export const Large: Story = {
  render: () => {
    ...
    return createMultiSelect('multi-select-large', options, {
...
export const Chips: Story = {
  render: () => {
    ...
    description.textContent = 'Selected items displayed as removable chips';
    ...
    const multiSelect = createMultiSelect('multi-select-chips', options, {
...
export const ThemeComparison: Story = {
  render: (args) => {
    return createThemeGrid(() => {
      ...
      wrapper.className = `aural-multi-select${args.size ? ` aural-multi-select--${args.size}` : ''}`;
