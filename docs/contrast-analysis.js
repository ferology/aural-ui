...
const combinations = [
  // Primary color tests
  {
    bg: 'bg-primary',
    text: 'primary-400',
    context: 'Primary button text on dark bg',
    size: 'large',
  },
  {
    bg: 'bg-secondary',
    text: 'primary-400',
    context: 'Primary color on secondary bg',
    size: 'normal',
  },
  { bg: 'primary-400', text: 'bg-primary', context: 'Button background (inverted)', size: 'large' },
  {
    bg: 'primary-400',
    text: 'text-primary',
    context: 'Primary button with white text',
    size: 'large',
  },
  ...
  { bg: 'bg-primary', text: 'text-primary', context: 'Primary text on primary bg', size: 'normal' },
  {
    bg: 'bg-primary',
    text: 'text-secondary',
    context: 'Secondary text on primary bg',
    size: 'normal',
  },
  { bg: 'bg-primary', text: 'text-muted', context: 'Muted text on primary bg', size: 'normal' },
  {
    bg: 'bg-secondary',
    text: 'text-primary',
    context: 'Primary text on secondary bg',
    size: 'normal',
  },
  ...
  { bg: 'bg-hover', text: 'text-primary', context: 'Hover state text', size: 'normal' },
  {
    bg: 'bg-hover',
    text: 'primary-400',
    context: 'Hover state with primary color',
    size: 'normal',
  },
...
for (const [themeKey, theme] of Object.entries(themes)) {
  ...
  console.log(
    `  Summary: ${results[themeKey].passed}/${total} combinations passed (${percentage}%)\n`
  );
}
...
for (const [themeKey, result] of Object.entries(results)) {
  ...
  console.log(
    `${status} ${themes[themeKey].name}: ${result.passed}/${total} passed (${percentage}%)`
  );
}
