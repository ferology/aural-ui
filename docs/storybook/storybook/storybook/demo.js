...
(function() {
    ...
    function renderQuickLinks() {
        return `
            <div style="padding: 0 var(--space-3); margin-bottom: var(--space-4);">
                <a href="https://ferology.github.io/aural-ui/storybook/" target="_blank" class="btn btn-primary btn-sm" style="width: 100%; display: flex; align-items: center; justify-content: center; gap: var(--space-2);">
            ...
            <div style="padding: 0 var(--space-3); margin-bottom: var(--space-5);">
                <div class="aural-search-bar">
                    <div class="aural-search-bar__wrapper">
                        ...
                        <input type="text" id="demo-search" class="aural-search-bar__input" placeholder="Search (⌘+K)" autocomplete="off" aria-label="Search">
                    </div>
                </div>
            </div>
        `;
    ...
    function renderThemeSelector() {
        const themes = [
            ...
            { id: 'prismatic', name: 'Prismatic', description: 'Iridescent purples' },
            { id: 'high-contrast', name: 'High Contrast', description: 'Maximum accessibility' },
            { id: 'colorblind-friendly', name: 'Colorblind', description: 'Optimized for CVD' },
    ...
    function initializeSearch() {
        ...
        searchInput.placeholder = `Search (${modifier}+K)`;
    }
