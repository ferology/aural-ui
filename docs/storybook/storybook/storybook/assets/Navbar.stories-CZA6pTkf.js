const ua={title:"Components/Navbar",tags:["autodocs"],parameters:{docs:{description:{component:"Top navigation bar with branding, links, and actions. Supports responsive design, icons, search, notifications, and multiple variants."}},layout:"fullscreen"},argTypes:{brand:{control:"text",description:"Brand name or logo text",table:{type:{summary:"string"},defaultValue:{summary:"Aural"}}},variant:{control:"select",options:["default","sticky","transparent","blur"],description:"Visual variant of the navbar",table:{type:{summary:"string"},defaultValue:{summary:"default"}}},size:{control:"select",options:["sm","default","lg"],description:"Size of the navbar",table:{type:{summary:"string"},defaultValue:{summary:"default"}}},withIcons:{control:"boolean",description:"Include icons in navigation links"},withSearch:{control:"boolean",description:"Include search bar"},withNotifications:{control:"boolean",description:"Include notification badge"},withUserMenu:{control:"boolean",description:"Include user profile menu"},notificationCount:{control:"number",description:"Number of unread notifications",if:{arg:"withNotifications"}}}},i=a=>{const e=a.variant&&a.variant!=="default"?`aural-navbar--${a.variant}`:"",n=a.size&&a.size!=="default"?`aural-navbar--${a.size}`:"",r=document.createElement("div");return r.innerHTML=`
  ...
  `,setTimeout(()=>{var t;window.lucide&&window.lucide.createIcons(),(t=window.Aural)!=null&&t.initNavbar&&window.Aural.initNavbar()},0),r},o={args:{brand:"Aural"},render:i},l={args:{brand:"Brand",withIcons:!0},render:i,parameters:{docs:{description:{story:"Navbar with icons in both the brand and navigation links for enhanced visual hierarchy."}}}},c={args:{brand:"Logo",withSearch:!0},render:i,parameters:{docs:{description:{story:"Navbar with an integrated search bar in the actions area."}}}},d={args:{brand:"Aural",withNotifications:!0,notificationCount:3},render:i,parameters:{docs:{description:{story:"Navbar with notification badge showing unread count. The badge pulses to draw attention."}}}},u={args:{brand:"Dashboard",withUserMenu:!0,withSearch:!0},render:i,parameters:{docs:{description:{story:"Navbar with user profile avatar instead of sign-in buttons, typical for authenticated views."}}}},v={args:{brand:"Sticky Nav",variant:"sticky"},render:i,parameters:{docs:{description:{story:"Navbar that stays at the top of the viewport when scrolling. Uses position: sticky."}}}},b={args:{brand:"Brand",variant:"transparent"},render:a=>{const e=i(a),n=document.createElement("div");return n.style.cssText="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-hover)); padding: var(--space-8); min-height: 400px;",n.appendChild(e),setTimeout(()=>{const r=n.querySelector(".aural-navbar");if(r){const t=r.querySelector(".aural-navbar__brand"),ca=r.querySelectorAll(".aural-navbar__link"),da=r.querySelectorAll(".btn");t&&(t.style.color="white"),ca.forEach(s=>s.style.color="rgba(255,255,255,0.8)"),da.forEach(s=>{s.style.color="white",s.style.borderColor="white"})}},0),n},parameters:{docs:{description:{story:"Transparent navbar perfect for hero sections or background images. Customize text colors as needed."}}}},p={args:{brand:"Blur Nav",variant:"blur"},render:i,parameters:{docs:{description:{story:"Navbar with frosted glass effect (backdrop blur) for a modern aesthetic."}}}},h={args:{brand:"Small",size:"sm"},render:i,parameters:{docs:{description:{story:"Compact navbar variant for space-constrained layouts."}}}},m={args:{brand:"Large",size:"lg"},render:i,parameters:{docs:{description:{story:"Large navbar variant for prominent navigation."}}}},_={render:()=>{const a=document.createElement("div");return a.innerHTML=`
    ...
    `).join("");return a.innerHTML=n,setTimeout(()=>{var r;window.lucide&&window.lucide.createIcons(),(r=window.Aural)!=null&&r.initNavbar&&window.Aural.initNavbar()},0),a},parameters:{docs:{description:{story:"Side-by-side comparison of different navbar variants to see how they appear in various themes."}}}};var y,k,S;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    brand: 'Aural'
  },
  render: createNavbar
}`,...(S=(k=o.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var N,x,T;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    brand: 'Brand',
    withIcons: true
  },
...
}`,...(T=(x=l.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var A,E,M;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    brand: 'Logo',
    withSearch: true
  },
...
}`,...(M=(E=c.parameters)==null?void 0:E.docs)==null?void 0:M.source}}};var C,L,H;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    brand: 'Aural',
...
}`,...(H=(L=d.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};var z,I,U;u.parameters={...u.parameters,docs:{...(z=u.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    brand: 'Dashboard',
    withUserMenu: true,
    withSearch: true
...
}`,...(U=(I=u.parameters)==null?void 0:I.docs)==null?void 0:U.source}}};var $,B,W;v.parameters={...v.parameters,docs:{...($=v.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    brand: 'Sticky Nav',
    variant: 'sticky'
  },
...
}`,...(W=(B=v.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var q,D,P;b.parameters={...b.parameters,docs:{...(q=b.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    brand: 'Brand',
    variant: 'transparent'
  },
...
}`,...(P=(D=b.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};var R,O,V;p.parameters={...p.parameters,docs:{...(R=p.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    brand: 'Blur Nav',
    variant: 'blur'
  },
...
}`,...(V=(O=p.parameters)==null?void 0:O.docs)==null?void 0:V.source}}};var F,j,G;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    brand: 'Small',
    size: 'sm'
  },
...
}`,...(G=(j=h.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var J,K,Q;m.parameters={...m.parameters,docs:{...(J=m.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    brand: 'Large',
    size: 'lg'
  },
...
}`,...(Q=(K=m.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};var X,Y,Z;_.parameters={..._.parameters,docs:{...(X=_.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.innerHTML = \`
      <nav class="aural-navbar" role="navigation" aria-label="E-commerce navigation">
...
}`,...(Z=(Y=_.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var aa,ra,ea;g.parameters={...g.parameters,docs:{...(aa=g.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.innerHTML = \`
      <nav class="aural-navbar" role="navigation" aria-label="Dashboard navigation">
...
}`,...(ea=(ra=g.parameters)==null?void 0:ra.docs)==null?void 0:ea.source}}};var na,ia,ta;w.parameters={...w.parameters,docs:{...(na=w.parameters)==null?void 0:na.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.innerHTML = \`
      <nav class="aural-navbar" role="navigation" aria-label="Responsive navigation" id="mobile-navbar">
...
}`,...(ta=(ia=w.parameters)==null?void 0:ia.docs)==null?void 0:ta.source}}};var sa,oa,la;f.parameters={...f.parameters,docs:{...(sa=f.parameters)==null?void 0:sa.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    const themes = [{
      name: 'Default',
...
}`,...(la=(oa=f.parameters)==null?void 0:oa.docs)==null?void 0:la.source}}};const va=["Basic","WithIcons","WithSearch","WithNotifications","WithUserMenu","StickyNavbar","TransparentNavbar","BlurNavbar","SmallSize","LargeSize","EcommerceHeader","SaaSDashboard","MobileResponsive","ThemeComparison"];export{o as Basic,p as BlurNavbar,_ as EcommerceHeader,m as LargeSize,w as MobileResponsive,g as SaaSDashboard,h as SmallSize,v as StickyNavbar,f as ThemeComparison,b as TransparentNavbar,l as WithIcons,d as WithNotifications,c as WithSearch,u as WithUserMenu,va as __namedExportsOrder,ua as default};
