...
\`\`\`
        `.trim()}}},argTypes:{value:{control:{type:"number",min:0,max:5,step:.5},description:"Current rating value"},max:{control:{type:"number",min:3,max:10,step:1},description:"Maximum rating value"},readonly:{control:"boolean",description:"Read-only display mode"},disabled:{control:"boolean",description:"Disabled state"},allowHalf:{control:"boolean",description:"Allow half-star ratings"},size:{control:"select",options:["sm","md","lg"],description:"Rating size"},showValue:{control:"boolean",description:"Show numeric value"},showCount:{control:"boolean",description:"Show review count"},count:{control:{type:"number",min:0},description:"Number of reviews"},icon:{control:"select",options:["star","heart"],description:"Icon type"},color:{control:"select",options:["default","primary","success","error"],description:"Color variant"}}},L="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",A="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z";function p(e){const t=document.createElement("div"),n=["aural-rating"];e.readonly&&n.push("aural-rating--readonly"),e.disabled&&n.push("aural-rating--disabled"),e.size&&e.size!=="md"&&n.push(`aural-rating--${e.size}`),e.color&&e.color!=="default"&&n.push(`aural-rating--${e.color}`),e.icon==="heart"&&n.push("aural-rating--heart"),t.className=n.join(" "),t.setAttribute("data-rating",String(e.value||0));const o=document.createElement("div");o.className="aural-rating__stars";const a=e.max||5,l=e.value||0,s=e.icon==="heart",m=s?"heart":"star";for(let r=1;r<=a;r++){const i=e.readonly?document.createElement("span"):document.createElement("button");let c="aural-rating__star";e.allowHalf&&r-.5===l?c+=" aural-rating__star--half":r<=l?c+=" aural-rating__star--filled":c+=" aural-rating__star--empty",i.className=c,i.setAttribute("data-value",String(r)),e.readonly||(i.setAttribute("aria-label",`Rate ${r} ${m}${r===1?"":"s"}`),i.setAttribute("tabindex","0"),e.disabled&&(i.disabled=!0));const d=document.createElementNS("http://www.w3.org/2000/svg","svg");if(d.setAttribute("class","aural-rating__star-icon"),d.setAttribute("viewBox","0 0 24 24"),d.setAttribute("fill","currentColor"),e.allowHalf&&r-.5===l){const u=document.createElementNS("http://www.w3.org/2000/svg","defs"),g=document.createElementNS("http://www.w3.org/2000/svg","linearGradient");g.setAttribute("id",`half-fill-${r}`);const y=document.createElementNS("http://www.w3.org/2000/svg","stop");y.setAttribute("offset","50%"),y.setAttribute("stop-color","var(--color-warning)");const V=document.createElementNS("http://www.w3.org/2000/svg","stop");if(V.setAttribute("offset","50%"),V.setAttribute("stop-color","var(--color-border-medium)"),g.appendChild(y),g.appendChild(V),u.appendChild(g),d.appendChild(u),s){const v=document.createElementNS("http://www.w3.org/2000/svg","path");v.setAttribute("d",A),v.setAttribute("fill",`url(#half-fill-${r})`),d.appendChild(v)}else{const v=document.createElementNS("http://www.w3.org/2000/svg","polygon");v.setAttribute("points",L),v.setAttribute("fill",`url(#half-fill-${r})`),d.appendChild(v)}}else if(s){const u=document.createElementNS("http://www.w3.org/2000/svg","path");u.setAttribute("d",A),d.appendChild(u)}else{const u=document.createElementNS("http://www.w3.org/2000/svg","polygon");u.setAttribute("points",L),d.appendChild(u)}i.appendChild(d),o.appendChild(i)}if(t.appendChild(o),e.showValue){const r=document.createElement("span");r.className="aural-rating__value",r.textContent=(l||0).toFixed(1),t.appendChild(r)}if(e.showCount&&e.count!==void 0){const r=document.createElement("span");r.className="aural-rating__count",r.textContent=`(${e.count.toLocaleString()})`,t.appendChild(r)}if(!e.readonly&&!e.disabled){let r=function(d){c.forEach((u,g)=>{u.classList.remove("aural-rating__star--filled","aural-rating__star--empty"),g<d?u.classList.add("aural-rating__star--filled"):u.classList.add("aural-rating__star--empty")})},i=l;const c=o.querySelectorAll(".aural-rating__star");c.forEach((d,u)=>{const g=u+1;d.addEventListener("mouseenter",()=>{r(g)}),d.addEventListener("click",()=>{if(i=g,t.setAttribute("data-rating",String(i)),e.showValue){const y=t.querySelector(".aural-rating__value");y&&(y.textContent=i.toFixed(1))}})}),t.addEventListener("mouseleave",()=>{r(i)})}return t}const h={render:e=>p(e),args:{value:0,max:5,readonly:!1,disabled:!1,allowHalf:!1,size:"md",showValue:!0,showCount:!1,count:0,icon:"star",color:"default"}},b={render:e=>{const t=document.createElement("div");return t.style.display="flex",t.style.flexDirection="column",t.style.gap="var(--space-4)",t.style.padding="var(--space-4)",[3.5,4.5].forEach(o=>{t.appendChild(p({...e,value:o,readonly:!0,allowHalf:!0,showValue:!0}))}),t},args:{max:5,icon:"star",size:"md"}},f={render:e=>p(e),args:{value:4.5,max:5,readonly:!0,allowHalf:!0,size:"md",showValue:!0,showCount:!0,count:1234,icon:"star",color:"default"}},x={render:e=>p(e),args:{value:3,max:5,readonly:!1,disabled:!0,size:"md",showValue:!0,icon:"star",color:"default"}},w={render:e=>{const t=document.createElement("div");t.style.display="flex",t.style.flexDirection="column",t.style.gap="var(--space-4)",t.style.padding="var(--space-4)";const n=p({...e,value:4,icon:"star",readonly:!0,showValue:!0}),o=document.createElement("div");o.style.fontSize="var(--text-sm)",o.style.color="var(--color-text-secondary)",o.textContent="Stars";const a=document.createElement("div");a.appendChild(o),a.appendChild(n),t.appendChild(a);const l=p({...e,value:5,icon:"heart",readonly:!0,showValue:!1}),s=document.createElement("div");s.style.fontSize="var(--text-sm)",s.style.color="var(--color-text-secondary)",s.textContent="Favorite";const m=document.createElement("div");return m.appendChild(s),m.appendChild(l),t.appendChild(m),t},args:{max:5,size:"md"}},C={render:e=>p(e),args:{value:4.3,max:5,readonly:!0,allowHalf:!0,size:"md",showValue:!0,showCount:!0,count:12845,icon:"star",color:"default"}},E={render:()=>{const e=document.createElement("div");return e.style.display="flex",e.style.flexDirection="column",e.style.gap="var(--space-6)",e.style.padding="var(--space-4)",[{size:"sm",label:"Small",value:3,count:45},{size:"md",label:"Default",value:4,count:256},{size:"lg",label:"Large",value:5,count:1845}].forEach(n=>{const o=document.createElement("div"),a=document.createElement("div");a.textContent=n.label,a.style.fontSize="var(--text-sm)",a.style.color="var(--color-text-secondary)",a.style.marginBottom="var(--space-2)",o.appendChild(a);const l=p({value:n.value,max:5,readonly:!0,size:n.size,showValue:!0,showCount:!0,count:n.count,icon:"star",color:"default"});o.appendChild(l),e.appendChild(o)}),e}},S={render:()=>{const e=document.createElement("div");return e.style.display="flex",e.style.flexDirection="column",e.style.gap="var(--space-4)",e.style.padding="var(--space-4)",[{color:"default",label:"Default (Warning)",value:4},{color:"primary",label:"Primary",value:4},{color:"success",label:"Success",value:5},{color:"error",label:"Error",value:2}].forEach(n=>{const o=document.createElement("div"),a=document.createElement("div");a.textContent=n.label,a.style.fontSize="var(--text-sm)",a.style.color="var(--color-text-secondary)",a.style.marginBottom="var(--space-2)",o.appendChild(a);const l=p({value:n.value,max:5,readonly:!0,size:"md",showValue:!0,icon:"star",color:n.color});o.appendChild(l),e.appendChild(o)}),e}},_={render:()=>{const e=document.createElement("div");e.style.maxWidth="500px",e.style.padding="var(--space-6)",e.style.background="var(--color-bg-secondary)",e.style.borderRadius="var(--radius-md)",e.style.border="1px solid var(--color-border-subtle)";const t=document.createElement("h3");t.textContent="Write a Review",t.style.margin="0 0 var(--space-4) 0",t.style.fontSize="var(--text-lg)",t.style.fontWeight="var(--font-semibold)",t.style.color="var(--color-text-primary)",e.appendChild(t);const n=document.createElement("label");n.textContent="Your Rating",n.style.display="block",n.style.marginBottom="var(--space-2)",n.style.fontSize="var(--text-sm)",n.style.fontWeight="var(--font-medium)",n.style.color="var(--color-text-secondary)",e.appendChild(n);const o=p({value:0,max:5,readonly:!1,size:"lg",showValue:!0,icon:"star",color:"default"});e.appendChild(o);const a=document.createElement("textarea");a.className="input",a.placeholder="Tell us about your experience...",a.style.marginTop="var(--space-4)",a.style.width="100%",a.style.minHeight="100px",a.style.padding="var(--space-3)",a.style.fontSize="var(--text-base)",a.style.borderRadius="var(--radius-md)",a.style.border="1px solid var(--color-border-medium)",a.style.background="var(--color-bg-primary)",a.style.color="var(--color-text-primary)",e.appendChild(a);const l=document.createElement("button");return l.className="btn btn-primary",l.textContent="Submit Review",l.style.marginTop="var(--space-4)",e.appendChild(l),e}},z={render:()=>{const e=document.createElement("div");e.style.maxWidth="600px",e.style.padding="var(--space-6)",e.style.background="var(--color-bg-primary)",e.style.borderRadius="var(--radius-md)";const t=document.createElement("div");t.style.display="flex",t.style.justifyContent="space-between",t.style.alignItems="center",t.style.marginBottom="var(--space-4)";const n=document.createElement("h3");n.textContent="Customer Reviews",n.style.margin="0",n.style.fontSize="var(--text-lg)",n.style.fontWeight="var(--font-semibold)",n.style.color="var(--color-text-primary)",t.appendChild(n);const o=p({value:4.3,max:5,readonly:!0,allowHalf:!0,size:"md",showValue:!0,showCount:!0,count:1234,icon:"star",color:"default"});return t.appendChild(o),e.appendChild(t),[{stars:5,count:850,percentage:69},{stars:4,count:234,percentage:19},{stars:3,count:98,percentage:8},{stars:2,count:37,percentage:3},{stars:1,count:15,percentage:1}].forEach(l=>{const s=document.createElement("div");s.style.display="flex",s.style.alignItems="center",s.style.gap="var(--space-3)",s.style.marginBottom="var(--space-2)";const m=document.createElement("span");m.textContent=`${l.stars} star`,m.style.fontSize="var(--text-sm)",m.style.color="var(--color-text-secondary)",m.style.width="50px",s.appendChild(m);const r=document.createElement("div");r.style.flex="1",r.style.height="8px",r.style.background="var(--color-bg-tertiary)",r.style.borderRadius="var(--radius-full)",r.style.overflow="hidden";const i=document.createElement("div");i.style.height="100%",i.style.width=`${l.percentage}%`,i.style.background="var(--color-warning)",r.appendChild(i),s.appendChild(r);const c=document.createElement("span");c.textContent=String(l.count),c.style.fontSize="var(--text-sm)",c.style.color="var(--color-text-secondary)",c.style.width="50px",c.style.textAlign="right",s.appendChild(c),e.appendChild(s)}),e}},R={render:e=>de(()=>p(e)),args:{value:4,max:5,readonly:!0,allowHalf:!1,size:"md",showValue:!0,showCount:!1,icon:"star",color:"default"},argTypes:{value:{control:{type:"number",min:0,max:5,step:.5},description:"Current rating value"},max:{control:{type:"number",min:3,max:10,step:1},description:"Maximum rating value"},readonly:{control:"boolean",description:"Read-only display mode"},allowHalf:{control:"boolean",description:"Allow half-star ratings"},size:{control:"select",options:["sm","md","lg"],description:"Rating size"},showValue:{control:"boolean",description:"Show numeric value"},showCount:{control:"boolean",description:"Show review count"},icon:{control:"select",options:["star","heart"],description:"Icon type"},color:{control:"select",options:["default","primary","success","error"],description:"Color variant"}}};var H,k,N;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
