import{c as K}from"./createThemeGrid-DWAncU4Q.js";const Q={title:"Components/Overlay/Context Menu",tags:["autodocs"],parameters:{docs:{description:{component:`
...
- Works with Shift+F10 keyboard shortcut
        `.trim()}}}},o=()=>{setTimeout(()=>{var a;(a=window.Aural)!=null&&a.initContextMenu&&window.Aural.initContextMenu(),typeof lucide<"u"&&lucide.createIcons()},0)},c={render:()=>{const a=document.createElement("div");a.style.cssText=`
      padding: var(--space-8);
      display: flex;
    ...
    `,a.appendChild(t),document.body.appendChild(e),t.addEventListener("contextmenu",n=>{n.preventDefault(),document.querySelectorAll(".aural-context-menu").forEach(r=>r.classList.remove("aural-context-menu--open")),e.style.left=n.clientX+"px",e.style.top=n.clientY+"px",e.classList.add("aural-context-menu--open")}),document.addEventListener("click",()=>{e.classList.remove("aural-context-menu--open")}),o(),a}},i={render:()=>{const a=document.createElement("div");a.style.cssText="padding: var(--space-8); display: flex; justify-content: center; min-height: 400px;";const t=document.createElement("div");t.className="context-trigger",t.id="separators-trigger",t.style.cssText=`
      background: var(--color-bg-secondary);
      border: 2px dashed var(--color-border-medium);
      border-radius: var(--radius-lg);
      padding: var(--space-8);
    ...
    `,a.appendChild(t),document.body.appendChild(e),t.addEventListener("contextmenu",n=>{n.preventDefault(),document.querySelectorAll(".aural-context-menu").forEach(r=>r.classList.remove("aural-context-menu--open")),e.style.left=n.clientX+"px",e.style.top=n.clientY+"px",e.classList.add("aural-context-menu--open")}),document.addEventListener("click",()=>{e.classList.remove("aural-context-menu--open")}),o(),a}},_={render:()=>{const a=document.createElement("div");a.style.cssText="padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;";const t=document.createElement("div");t.className="context-trigger",t.id="table-row-trigger",t.style.cssText=`
      background: var(--color-bg-secondary);
      border: 2px dashed var(--color-border-medium);
      border-radius: var(--radius-lg);
      padding: var(--space-8);
    ...
    `,a.appendChild(t),document.body.appendChild(e),t.addEventListener("contextmenu",n=>{n.preventDefault(),document.querySelectorAll(".aural-context-menu").forEach(r=>r.classList.remove("aural-context-menu--open")),e.style.left=n.clientX+"px",e.style.top=n.clientY+"px",e.classList.add("aural-context-menu--open")}),document.addEventListener("click",()=>{e.classList.remove("aural-context-menu--open")}),o(),a}},g={render:()=>K(()=>{const a=document.createElement("div");a.className="context-trigger",a.id=`theme-trigger-${Math.random().toString(36).substr(2,9)}`,a.style.cssText=`
      ...
      `,document.body.appendChild(e),a.addEventListener("contextmenu",n=>{n.preventDefault(),document.querySelectorAll(".aural-context-menu").forEach(r=>r.classList.remove("aural-context-menu--open")),e.style.left=n.clientX+"px",e.style.top=n.clientY+"px",e.classList.add("aural-context-menu--open")}),document.addEventListener("click",()=>{e.classList.remove("aural-context-menu--open")}),o(),a})};var v,b,h;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => {
...
}`,...(h=(b=c.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var y,f,w;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
...
}`,...(w=(f=s.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};var L,E,T;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
...
}`,...(T=(E=i.parameters)==null?void 0:E.docs)==null?void 0:T.source}}};var C,k,M;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(M=(k=l.parameters)==null?void 0:k.docs)==null?void 0:M.source}}};var S,D,A;u.parameters={...u.parameters,docs:{...(S=u.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(A=(D=u.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var N,H,X;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(X=(H=m.parameters)==null?void 0:H.docs)==null?void 0:X.source}}};var q,z,j;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(j=(z=d.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};var Y,F,I;p.parameters={...p.parameters,docs:{...(Y=p.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 400px;';
    const trigger = document.createElement('div');
...
}`,...(I=(F=p.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var P,R,V;x.parameters={...x.parameters,docs:{...(P=x.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(V=(R=x.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};var W,O,G;_.parameters={..._.parameters,docs:{...(W=_.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => {
    const wrapper = document.createElement('div');
    wrapper.style.cssText = 'padding: var(--space-8); display: flex; justify-content: center; min-height: 300px;';
    const trigger = document.createElement('div');
...
}`,...(G=(O=_.parameters)==null?void 0:O.docs)==null?void 0:G.source}}};var U,$,B;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
...
}`,...(B=($=g.parameters)==null?void 0:$.docs)==null?void 0:B.source}}};const Z=["Default","WithIcons","WithSeparators","WithDisabledItems","WithCheckableItems","CompactVariant","DangerActions","FileManagerPattern","TextEditorPattern","TableRowPattern","ThemeComparison"];export{m as CompactVariant,d as DangerActions,c as Default,p as FileManagerPattern,_ as TableRowPattern,x as TextEditorPattern,g as ThemeComparison,u as WithCheckableItems,l as WithDisabledItems,s as WithIcons,i as WithSeparators,Z as __namedExportsOrder,Q as default};
