import{j as n,M as i}from"./index-DrXj_NCA.js";import{useMDXComponents as a}from"./index-CiS4Lcw6.js";import"./iframe-CPaSsIkd.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D1c3tIrF.js";import"./index-DrFu-skq.js";function t(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(i,{title:"Getting Started/Framework Guide",parameters:{toolbar:{theme:{hidden:!0}}}}),`
`,n.jsxs("div",{style:{fontFamily:"var(--font-sans, system-ui, -apple-system, sans-serif)",maxWidth:"900px",margin:"0 auto",padding:"3rem 2rem"},children:[n.jsx(e.h1,{id:"framework-guide",children:"Framework Guide"}),n.jsxs(e.p,{children:["Aural UI is ",n.jsx(e.strong,{children:"framework-agnostic"})," and works seamlessly with vanilla JavaScript, React, Vue, Svelte, and other modern frameworks."]}),n.jsx(e.hr,{}),n.jsx(e.h2,{id:"vanilla-javascript--html",children:"Vanilla JavaScript / HTML"}),n.jsx(e.p,{children:"The simplest way to use Aural UI - just HTML and CSS classes."}),n.jsx(e.h3,{id:"setup",children:"Setup"}),n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-html",children:`<!DOCTYPE html>
<html lang="en">
<head>
...
`})}),n.jsx(e.hr,{}),n.jsx(e.h2,{id:"key-differences-summary",children:"Key Differences Summary"}),n.jsxs(e.p,{children:[`| Feature | Vanilla | React | Vue | Svelte |
|---------|---------|-------|-----|--------|
