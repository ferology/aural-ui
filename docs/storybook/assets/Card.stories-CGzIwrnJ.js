const _={title:"Components/Card",tags:["autodocs"],parameters:{docs:{description:{component:"Flexible, composable content containers for organizing and displaying related information."}}},argTypes:{hover:{control:"boolean",description:"Add hover effect with card-hover class"}}},n={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="400px";const t=document.createElement("div");return t.className="card",t.innerHTML=`
      <div class="card-body">
    ...
    `,e.appendChild(t),e}},i={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="300px";const t=document.createElement("div");return t.className="card",t.innerHTML=`
      <div class="card-body">
    ...
    `,e.appendChild(t),e}},d={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="600px";const t=document.createElement("div");return t.className="card",t.style.padding="0",t.style.overflow="hidden",t.innerHTML=`
    ...
    `,e.appendChild(t),e}},p={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.display="grid",e.style.gridTemplateColumns="repeat(auto-fit, minmax(250px, 1fr))",e.style.gap="var(--space-6)",[{title:"Total Revenue",value:"$45,231",change:"+12%",trend:"up",icon:'<line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>'},{title:"New Users",value:"1,429",change:"+8%",trend:"up",icon:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>'},{title:"Conversion Rate",value:"3.24%",change:"-2%",trend:"down",icon:'<circle cx="12" cy="12" r="10"></circle><polyline points="16 12 12 8 8 12"></polyline><line x1="12" y1="16" x2="12" y2="8"></line>'}].forEach(({title:m,value:y,change:g,trend:a,icon:h})=>{const r=document.createElement("div");r.className="card";const I=a==="up"?"badge-success":"badge-error",U=a==="up"?"var(--color-success)":"var(--color-error)";r.innerHTML=`
        <div class="card-body">
          <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: var(--space-3);">
            <h4 style="margin: 0; color: var(--color-text-primary);">${m}</h4>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="${U}" stroke-width="2">
              ${h}
            </svg>
          </div>
          <div style="font-size: var(--text-3xl); font-weight: var(--font-bold); color: var(--color-text-primary); margin-bottom: var(--space-2);">${y}</div>
          <div style="display: flex; align-items: center; gap: var(--space-2);">
            <span class="badge ${I} badge-sm">
              ${g}
            </span>
            <span style="font-size: var(--text-sm); color: var(--color-text-tertiary);">vs last month</span>
          </div>
        </div>
      `,e.appendChild(r)}),e}},v={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.display="grid",e.style.gridTemplateColumns="repeat(auto-fit, minmax(200px, 1fr))",e.style.gap="var(--space-6)",[{title:"Fast Performance",description:"Lightning-fast load times",color:"var(--color-primary)",bgColor:"var(--color-primary-subtle)",icon:'<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>'},{title:"Secure by Default",description:"Built-in security features",color:"var(--color-success)",bgColor:"var(--color-success-subtle)",icon:'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>'},{title:"Mobile Friendly",description:"Responsive everywhere",color:"var(--color-secondary)",bgColor:"var(--color-secondary-subtle)",icon:'<rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line>'}].forEach(({title:m,description:y,color:g,bgColor:a,icon:h})=>{const r=document.createElement("div");r.className="card",r.innerHTML=`
        <div class="card-body" style="text-align: center;">
          <div style="width: 48px; height: 48px; margin: 0 auto var(--space-3); background: ${a}; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; color: ${g};">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ${h}
            </svg>
          </div>
          <h4 style="margin: 0 0 var(--space-2) 0; color: var(--color-text-primary);">${m}</h4>
          <p style="margin: 0; color: var(--color-text-secondary); font-size: var(--text-sm);">${y}</p>
        </div>
      `,e.appendChild(r)}),e}};var u,x,b;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
...
}`,...(b=(x=n.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var f,w,C;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '400px';
...
}`,...(C=(w=o.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var M,k,z;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(z=(k=i.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};var E,H,T;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '300px';
...
}`,...(T=(H=s.parameters)==null?void 0:H.docs)==null?void 0:T.source}}};var $,N,j;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(j=(N=c.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var A,L,S;l.parameters={...l.parameters,docs:{...(A=l.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(S=(L=l.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var B,W,P;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(P=(W=d.parameters)==null?void 0:W.docs)==null?void 0:P.source}}};var F,R,V;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(V=(R=p.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};var D,G,q;v.parameters={...v.parameters,docs:{...(D=v.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.display = 'grid';
...
}`,...(q=(G=v.parameters)==null?void 0:G.docs)==null?void 0:q.source}}};const O=["BasicCard","WithHeaderAndFooter","StatCard","WithImage","ProductCard","HoverableCard","HorizontalCard","CardGrid","FeatureGrid"];export{n as BasicCard,p as CardGrid,v as FeatureGrid,d as HorizontalCard,l as HoverableCard,c as ProductCard,i as StatCard,o as WithHeaderAndFooter,s as WithImage,O as __namedExportsOrder,_ as default};
