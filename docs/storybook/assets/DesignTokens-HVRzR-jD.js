...
`})}),e.jsx(r.hr,{}),e.jsx(r.h2,{id:"-token-categories",children:"📚 Token Categories"}),e.jsx(r.h3,{id:"colors",children:"Colors"}),e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(255, 255, 255, 0.1)",padding:"1rem",borderRadius:"8px",marginBottom:"1rem",color:"#ffffff"},children:[e.jsx(r.p,{children:e.jsx(r.strong,{children:"Backgrounds:"})}),e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-css",children:`--color-bg-primary       /* Main page background */
...
`})})]}),e.jsx(r.h3,{id:"spacing",children:"Spacing"}),e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(255, 255, 255, 0.1)",padding:"1rem",borderRadius:"8px",marginBottom:"1rem",color:"#ffffff"},children:[e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-css",children:`--space-1: 0.25rem;    /* 4px */
--space-2: 0.5rem;     /* 8px */
--space-4: 1rem;       /* 16px */
--space-6: 1.5rem;     /* 24px */
--space-8: 2rem;       /* 32px */
...
`})})]}),e.jsx(r.h3,{id:"typography",children:"Typography"}),e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(255, 255, 255, 0.1)",padding:"1rem",borderRadius:"8px",marginBottom:"1rem",color:"#ffffff"},children:[e.jsx(r.p,{children:e.jsx(r.strong,{children:"Font Sizes:"})}),e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-css",children:`--text-xs: 0.75rem;     /* 12px */
