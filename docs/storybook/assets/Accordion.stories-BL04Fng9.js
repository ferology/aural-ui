const E={title:"Components/Accordion",tags:["autodocs"],parameters:{docs:{description:{component:`
# Accordion Component
...
- Touch-friendly spacing between interactive elements
        `.trim()}}}},n=`<svg class="accordion-icon" viewBox="0 0 16 16" fill="currentColor" width="20" height="20">
  <path d="M4.22 6.22a.75.75 0 011.06 0L8 8.94l2.72-2.72a.75.75 0 111.06 1.06l-3.25 3.25a.75.75 0 01-1.06 0L4.22 7.28a.75.75 0 010-1.06z"/>
</svg>`,i={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e},parameters:{docs:{source:{code:`<div class="accordion">
  <div class="accordion-item" id="acc-item-1">
    <button class="accordion-header" aria-expanded="true" aria-controls="acc-panel-1">
      <span>What is Aural UI?</span>
      <svg class="accordion-icon" viewBox="0 0 16 16" fill="currentColor" width="20" height="20">
...
<\/script>`}}}},o={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion accordion-bordered",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e}},c={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion accordion-flush",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e}},d={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion accordion-always-open accordion-bordered",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e}},t={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e}},r={render:()=>{const e=document.createElement("div");e.style.padding="2rem",e.style.maxWidth="800px";const a=document.createElement("div");return a.className="accordion",a.innerHTML=`
    ...
    `,e.appendChild(a),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initAccordions()},100),e}};var s,l,p;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => {
...
}`,...(p=(l=i.parameters)==null?void 0:l.docs)==null?void 0:p.source}}};var u,m,v;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '800px';
...
}`,...(v=(m=o.parameters)==null?void 0:m.docs)==null?void 0:v.source}}};var h,f,b;c.parameters={...c.parameters,docs:{...(h=c.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '800px';
...
}`,...(b=(f=c.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var g,x,w;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '800px';
...
}`,...(w=(x=d.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var y,A,I;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '800px';
...
}`,...(I=(A=t.parameters)==null?void 0:A.docs)==null?void 0:I.source}}};var T,S,C;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.maxWidth = '800px';
...
}`,...(C=(S=r.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};const M=["Default","Bordered","Flush","AlwaysOpen","DefaultOpen","FAQ"];export{d as AlwaysOpen,o as Bordered,i as Default,t as DefaultOpen,r as FAQ,c as Flush,M as __namedExportsOrder,E as default};
