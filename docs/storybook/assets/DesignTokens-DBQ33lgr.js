import{j as r,M as a}from"./index-CL1AqDkI.js";import{useMDXComponents as o}from"./index-Cn307w12.js";import"./iframe-CtR2uDVl.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D1c3tIrF.js";import"./index-DrFu-skq.js";function n(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...s.components};return r.jsxs(r.Fragment,{children:[r.jsx(a,{title:"Getting Started/Design Tokens",parameters:{toolbar:{theme:{hidden:!1}}}}),`
...
`})}),r.jsx(e.hr,{}),r.jsx(e.h2,{id:"-token-categories",children:"📚 Token Categories"}),r.jsx(e.h3,{id:"colors",children:"Colors"}),r.jsxs("div",{style:{background:"var(--color-bg-tertiary)",padding:"var(--space-4)",borderRadius:"var(--radius-md)",marginBottom:"var(--space-4)"},children:[r.jsx(e.p,{children:r.jsx(e.strong,{children:"Backgrounds:"})}),r.jsx(e.pre,{children:r.jsx(e.code,{className:"language-css",children:`--color-bg-primary       /* Main page background */
...
`})})]}),r.jsx(e.h3,{id:"spacing",children:"Spacing"}),r.jsxs("div",{style:{background:"var(--color-bg-tertiary)",padding:"var(--space-4)",borderRadius:"var(--radius-md)",marginBottom:"var(--space-4)"},children:[r.jsx(e.pre,{children:r.jsx(e.code,{className:"language-css",children:`--space-1: 0.25rem;    /* 4px */
--space-2: 0.5rem;     /* 8px */
--space-4: 1rem;       /* 16px */
--space-6: 1.5rem;     /* 24px */
--space-8: 2rem;       /* 32px */
...
`})})]}),r.jsx(e.h3,{id:"typography",children:"Typography"}),r.jsxs("div",{style:{background:"var(--color-bg-tertiary)",padding:"var(--space-4)",borderRadius:"var(--radius-md)",marginBottom:"var(--space-4)"},children:[r.jsx(e.p,{children:r.jsx(e.strong,{children:"Font Sizes:"})}),r.jsx(e.pre,{children:r.jsx(e.code,{className:"language-css",children:`--text-xs: 0.75rem;     /* 12px */
