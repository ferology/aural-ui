const $={title:"Components/Drawer",tags:["autodocs"],parameters:{docs:{description:{component:`
# Drawer Component
...
- **Mobile considerations:**
  ...
  - Keep mobile drawer content concise to minimize scrolling
        `.trim()}}},argTypes:{position:{control:"select",options:["left","right","top","bottom"],description:"Position from which the drawer slides in. **left** (default, 320px wide) — primary navigation, slide from left edge. **right** (320px wide) — details, actions, shopping cart, slide from right edge. **top** (400px tall) — announcements, notifications, slide down from top. **bottom** (400px tall) — mobile action sheets, pickers, slide up from bottom. Width and height can be customized with size modifiers (--sm: 240/280px, --lg: 480/560px, --xl: 640/720px, --full: 100vw/100vh)."}}},n={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-primary",r.textContent="Open Left Drawer";const e="drawer-left",i=`
      <div class="aural-drawer-backdrop"></div>
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},d={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-secondary",r.textContent="Open Right Drawer";const e="drawer-right",i=`
      <div class="aural-drawer-backdrop"></div>
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},o={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-secondary",r.textContent="Open Top Drawer";const e="drawer-top",i=`
      <div class="aural-drawer-backdrop"></div>
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},l={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-secondary",r.textContent="Open Bottom Drawer";const e="drawer-bottom",i=`
      <div class="aural-drawer-backdrop"></div>
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},s={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-primary",r.innerHTML='<i data-lucide="menu" style="width: 16px; height: 16px;" aria-hidden="true"></i> Open Navigation';const e="drawer-nav",i=`
      <div class="aural-drawer-backdrop"></div>
      <div class="aural-drawer aural-drawer--left" id="${e}" role="dialog" aria-modal="true" aria-labelledby="${e}-title">
        <div class="aural-drawer__header">
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},c={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-primary",r.textContent="Open Form Drawer";const e="drawer-form",i=`
      <div class="aural-drawer-backdrop"></div>
      <div class="aural-drawer aural-drawer--right" id="${e}" role="dialog" aria-modal="true" aria-labelledby="${e}-title">
        <div class="aural-drawer__header">
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}},u={render:()=>{const a=document.createElement("div");a.style.padding="2rem";const r=document.createElement("button");r.className="btn btn-secondary",r.innerHTML='<i data-lucide="settings" style="width: 16px; height: 16px;" aria-hidden="true"></i> Settings';const e="drawer-settings",i=`
      <div class="aural-drawer-backdrop"></div>
      <div class="aural-drawer aural-drawer--right" id="${e}" role="dialog" aria-modal="true" aria-labelledby="${e}-title">
        <div class="aural-drawer__header">
    ...
    `,t=document.createElement("div");return t.innerHTML=i,r.onclick=()=>{typeof window.Aural<"u"&&window.Aural.openDrawer(e)},a.appendChild(r),a.appendChild(t),setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDrawers(),typeof window.lucide<"u"&&window.lucide.createIcons()},100),a}};var p,w,h;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
...
}`,...(h=(w=n.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};var m,v,b;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(b=(v=d.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var f,_,y;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(y=(_=o.parameters)==null?void 0:_.docs)==null?void 0:y.source}}};var g,x,k;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(k=(x=l.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var D,A,C;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(C=(A=s.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};var T,I,E;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(E=(I=c.parameters)==null?void 0:I.docs)==null?void 0:E.source}}};var L,M,B;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    const openButton = document.createElement('button');
...
}`,...(B=(M=u.parameters)==null?void 0:M.docs)==null?void 0:B.source}}};const H=["Left","Right","Top","Bottom","NavigationDrawer","WithForm","SettingsDrawer"];export{l as Bottom,n as Left,s as NavigationDrawer,d as Right,u as SettingsDrawer,o as Top,c as WithForm,H as __namedExportsOrder,$ as default};
