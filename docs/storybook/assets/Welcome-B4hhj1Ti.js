import{j as e,M as t}from"./index-Dmr2MUpP.js";import{useMDXComponents as i}from"./index-2LpyOtdV.js";import"./iframe-C0SrNjLe.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D1c3tIrF.js";import"./index-DrFu-skq.js";function s(n){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Getting Started/Welcome",parameters:{toolbar:{theme:{hidden:!0}}}}),`
`,e.jsxs("div",{style:{fontFamily:"var(--font-sans, system-ui, -apple-system, sans-serif)",maxWidth:"900px",margin:"0 auto",padding:"3rem 2rem"},children:[e.jsx(r.h1,{id:"welcome-to-aural-ui",children:"Welcome to Aural UI"}),e.jsx(r.p,{children:e.jsx(r.strong,{children:"A modern, accessible design system built for flexibility and customization"})}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"1.5rem",margin:"2rem 0"},children:[e.jsxs("div",{style:{padding:"1.5rem",background:"var(--color-bg-secondary, #f5f5f5)",border:"1px solid var(--color-border-subtle, rgba(0, 0, 0, 0.1))",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"0.5rem"},children:"🎨"}),e.jsx("h3",{style:{margin:"0 0 0.5rem 0",fontSize:"1.125rem"},children:"9 Built-in Themes"}),e.jsx("p",{style:{margin:0,opacity:.8,fontSize:"0.875rem"},children:e.jsx(r.p,{children:"From Dark & Light to Neon, Kinetic, Prismatic, and accessibility-focused themes"})})]}),e.jsxs("div",{style:{padding:"1.5rem",background:"var(--color-bg-secondary, #f5f5f5)",border:"1px solid var(--color-border-subtle, rgba(0, 0, 0, 0.1))",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"0.5rem"},children:"📦"}),e.jsx("h3",{style:{margin:"0 0 0.5rem 0",fontSize:"1.125rem"},children:"60+ Components"}),e.jsx("p",{style:{margin:0,opacity:.8,fontSize:"0.875rem"},children:e.jsx(r.p,{children:"Everything from buttons to notification centers, all production-ready"})})]}),e.jsxs("div",{style:{padding:"1.5rem",background:"var(--color-bg-secondary, #f5f5f5)",border:"1px solid var(--color-border-subtle, rgba(0, 0, 0, 0.1))",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"0.5rem"},children:"♿"}),e.jsx("h3",{style:{margin:"0 0 0.5rem 0",fontSize:"1.125rem"},children:"Accessibility First"}),e.jsx("p",{style:{margin:0,opacity:.8,fontSize:"0.875rem"},children:e.jsx(r.p,{children:"WCAG 2.1 AAA compliant with 7:1+ contrast ratios across all themes"})})]}),e.jsxs("div",{style:{padding:"1.5rem",background:"var(--color-bg-secondary, #f5f5f5)",border:"1px solid var(--color-border-subtle, rgba(0, 0, 0, 0.1))",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"2rem",marginBottom:"0.5rem"},children:"🔧"}),e.jsx("h3",{style:{margin:"0 0 0.5rem 0",fontSize:"1.125rem"},children:"Framework Agnostic"}),e.jsx("p",{style:{margin:0,opacity:.8,fontSize:"0.875rem"},children:e.jsx(r.p,{children:"Works with React, Vue, Svelte, or vanilla JavaScript"})})]})]}),e.jsx(r.hr,{}),e.jsx(r.h2,{id:"quick-start",children:"Quick Start"}),e.jsx(r.h3,{id:"installation",children:"Installation"}),e.jsx(r.p,{children:"Add Aural UI to your project:"}),e.jsx(r.pre,{children:e.jsx(r.code,{className:"language-bash",children:`# Clone the repository
