const R={title:"Components/Dropdown",tags:["autodocs"],parameters:{docs:{description:{component:`
# Dropdown Component
...
- **Trigger types:**
  ...
  - **Text link** (\`.dropdown-trigger\`): Inline text that opens menu on click
        `.trim()}}},argTypes:{trigger:{control:"select",options:["button","icon-only","avatar","text-link"],description:"Trigger type: button (standard with text), icon-only (three dots), avatar (user profile), text-link (inline text)"},placement:{control:"select",options:["bottom-left","bottom-right","top-left","top-right"],description:"Menu placement relative to trigger: bottom-left (default), bottom-right (.dropdown-right), auto-adjusts for viewport"},items:{control:"object",description:"Array of menu items with label, icon, href, and optional danger flag for destructive actions"},grouped:{control:"boolean",description:"Whether menu items are organized into sections with headers and dividers for better scannability"},icon:{control:"text",description:'Icon name for trigger button (e.g., "chevron-down", "more-vertical", "more-horizontal") via Lucide icons'}}},t={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="300px",e.innerHTML=`
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}},i={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="300px",e.innerHTML=`
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}},o={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="300px",e.innerHTML=`
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}},r={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="300px",e.innerHTML=`
      <div style="display: flex; gap: var(--space-4); flex-wrap: wrap;">
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}},d={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="300px",e.style.display="flex",e.style.justifyContent="flex-end",e.innerHTML=`
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}},n={render:()=>{const e=document.createElement("div");return e.style.padding="2rem",e.style.minHeight="400px",e.innerHTML=`
    ...
    `,setTimeout(()=>{typeof window.Aural<"u"&&window.Aural.initDropdowns(),typeof lucide<"u"&&lucide.createIcons()},100),e}};var p,c,u;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
...
}`,...(u=(c=t.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};var m,h,w;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '300px';
...
}`,...(w=(h=i.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var g,f,v;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '300px';
...
}`,...(v=(f=o.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var y,x,b;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '300px';
...
}`,...(b=(x=r.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var A,T,D;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '300px';
...
}`,...(D=(T=d.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};var M,S,H;n.parameters={...n.parameters,docs:{...(M=n.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
...
}`,...(H=(S=n.parameters)==null?void 0:S.docs)==null?void 0:H.source}}};var E,I,O;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '400px';
...
}`,...(O=(I=a.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};var L,N,j;s.parameters={...s.parameters,docs:{...(L=s.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '400px';
...
}`,...(j=(N=s.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var P,k,C;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
    container.style.padding = '2rem';
    container.style.minHeight = '400px';
...
}`,...(C=(k=l.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};const U=["Default","ButtonVariants","WithIcons","IconOnlyTrigger","RightAlignedMenu","WithHeadersAndSections","UserMenu","TableRowActions","WithNotifications"];export{i as ButtonVariants,t as Default,r as IconOnlyTrigger,d as RightAlignedMenu,s as TableRowActions,a as UserMenu,n as WithHeadersAndSections,o as WithIcons,l as WithNotifications,U as __namedExportsOrder,R as default};
